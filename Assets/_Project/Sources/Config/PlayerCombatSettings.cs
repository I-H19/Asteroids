...
{
    [CreateAssetMenu(fileName = "CombatSettings", menuName = "Settings/Combat/PlayerCombatSettings")]
    public class PlayerCombatSettings : ScriptableObject
    {
        [Header("Weapon")]
        [field: SerializeField] public float BulletCooldown { get; private set; } = 5f;
        [field: SerializeField] public DirectionalMoverSettings BulletMoverSettings { get; private set; }
